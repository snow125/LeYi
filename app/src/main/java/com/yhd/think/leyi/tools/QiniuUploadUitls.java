...
public class QiniuUploadUitls {
	...
	/** 在网站上查看 */
	private static final String ACCESS_KEY = "EmxtpU428wcFWA7l0IfByZFby0uMSWm5rM2fQFf5";
	/** 在网站上查看 */
	private static final String SECRET_KEY = "7nPY-LQfi5fgIufaxzl_B3sT_m4HQSf7KQRj8LA_";
    /** 你所创建的空间的名称*/
	private static final String bucketName = "leyiapp";
	...
	public boolean saveBitmapToJpegFile(Bitmap bitmap, String filePath) {
		return saveBitmapToJpegFile(bitmap, filePath, 100);
	}
	...
	public boolean saveBitmapToJpegFile(Bitmap bitmap, String filePath,
		...
		try {
			...
			BufferedOutputStream bufOutStr = new BufferedOutputStream(
					fileOutStr);
			resizeBitmap(bitmap)/*bitmap*/.compress(CompressFormat.JPEG, quality, bufOutStr);
			bufOutStr.flush();
			bufOutStr.close();
